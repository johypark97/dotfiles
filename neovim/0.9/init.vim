...
function! g:init#sourceScript(file)
...
call g:init#sourceScript('script/function.vim')
call g:init#sourceScript('script/plugin.vim')
call g:init#sourceScript('script/mapping.vim')
call g:init#sourceScript('script/config.vim')
call g:init#sourceScript('script/command.vim')
call g:init#sourceScript('script/autocmd.vim')
